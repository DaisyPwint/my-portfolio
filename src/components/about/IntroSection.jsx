...
const IntroSection = () => {
  return (
    <section>
      ...
      Due to the COVID-19 pandemic and the political situation in Myanmar, I had to take a break from my career aspirations and help my family with our business. However, last year, I decided to pursue my dream once again. I also worked as an intern front-end developer at Nexcode company in Mandalay for about four months in 2023, which was a great learning experience for me. 
      </p>
