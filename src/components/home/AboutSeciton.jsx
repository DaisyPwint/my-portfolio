      ...
      <div className='flex md:flex-row flex-col gap-5'>
        <div className='flex-[4_2_0%] lg:mt-10'>
          <p className='text-textColor'>
            As a frontend web developer, I am passionate about crafting seamless online experiences. My recent projects involve utilizing React, Next.js, Tailwind CSS, Shadcn UI and Ant Design, adding a modern and dynamic touch to web development.
          </p>
